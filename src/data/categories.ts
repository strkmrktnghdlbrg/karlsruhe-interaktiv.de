...
export const categories: Category[] = [
  ...
  { slug: "wissenschaft", name: "Wissenschaft", shortDesc: "KIT, Forschungszentren, Universitäten", icon: "atom" },
  ...
  { slug: "parks", name: "Parks & Grün", shortDesc: "Schlossgarten, Stadtgarten, Hardtwald", icon: "tree" },
