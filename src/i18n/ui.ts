...
export const ui = {
  ...
  "aria.closeMenu": { de: "Menü schliessen", en: "Close menu" },
  ...
  "restaurants.intro": {
    de: "Badische Klassiker, Sterneküche und internationale Vielfalt - eine kuratierte Auswahl der besten Lokale in Karlsruhe.",
  ...
  "restaurants.listLead": {
    de: "Von der legendären Oberlaender Weinstube bis zum Stern-Restaurant Sein, von badischen Brauhäusern bis zur Südstadt-Pho-Adresse - Karlsruhes Gastronomie in einer Übersicht.",
    en: "From the legendary Oberlaender Weinstube to the Michelin-starred Sein, from Baden brewpubs to the Südstadt's pho address - Karlsruhe's dining scene at a glance.",
  },
  "restaurants.metaDescription": {
    de: "Restaurants in Karlsruhe: Badisch, Stern-Küche, Italienisch, Asiatisch - geprüft, sortiert nach Bezirk und Küche.",
  ...
  "districts.intro": {
    de: "Historische Altstadt, moderne Wissenschaftsviertel, alternative Südstadt oder wohlhabender Villenvorort - jeder Karlsruher Bezirk hat sein Gesicht.",
    en: "Historic old town, modern science quarters, the alternative Südstadt or affluent villa suburbs - every Karlsruhe district has its own character.",
  },
  ...
  "detail.guestReviews": { de: "{n} Gäste-Bewertungen", en: "{n} guest reviews" },
  ...
  "news.attributionText": {
    de: "Diese Zusammenfassung basiert auf einem Bericht von {name} vom {date}. Den vollständigen Originalartikel mit allen Details findest du hier:",
  ...
  "guides.intro": {
    de: "Fertige Tagespläne für Karlsruhe - Erstbesucher, Familien, Regen. Jeder Plan verweist auf konkrete Sehenswürdigkeiten, Restaurants und Hotels.",
  ...
  "guides.indexDesc": {
    de: "Reise-Guides für Karlsruhe: 3 Tage, mit Kindern, bei Regen - Tag-für-Tag-Routen mit Hotel- und Restaurant-Empfehlungen.",
  ...
  "events.indexDescription": {
    de: "Karlsruher Events 2026: Das Fest, Schlosslichtspiele, Christkindlesmarkt, art Karlsruhe. Mit aktuellen Hotelpreisen für jeden Termin.",
  ...
  "events.intro": {
    de: "Die wichtigsten Karlsruher Anlässe - vom kostenlosen Open-Air-Festival Das Fest über die Schlosslichtspiele bis zur Kunstmesse art Karlsruhe. Zu jedem Termin zeigen wir aktuelle Hotelpreise für genau den Zeitraum.",
  ...
  "events.hotelsForDate": { de: "Hotels für diesen Termin →", en: "Hotels for these dates →" },
  ...
  "events.nights": { de: "{n} Nächte", en: "{n} nights" },
  "events.night": { de: "{n} Nacht", en: "{n} night" },
  "events.otherHeading": { de: "Weitere Anlässe in Karlsruhe", en: "More occasions in Karlsruhe" },
  "events.pastNotice": {
    de: "Dieses Event liegt in der Vergangenheit. Sobald der Termin für die nächste Saison feststeht, aktualisieren wir die Preise hier. Schau dir solange unseren {link} an.",
  ...
  "events.notBookableNotice": {
    de: "Der Termin steht bereits fest, liegt aber noch zu weit in der Zukunft für eine Hotelbuchung. Sobald der Zeitraum buchbar ist (etwa zwei Jahre vorher), zeigen wir hier aktuelle Preise. Schau dir solange unseren {link} an.",
  ...
  "events.noHotelsNotice": {
    de: "Aktuell zeigt Stay22 keine verfügbaren Hotels für diesen Zeitraum. Probier unseren {link}.",
  ...
  "events.fullHotelIndexLink": { de: "vollständigen Hotel-Index", en: "complete hotel index" },
  "events.priceNote": {
    de: "* Preise und Verfügbarkeit live via Stay22 → Booking.com. Bei Buchung über diese Links erhalten wir eine Provision - für dich entstehen keine Mehrkosten. Preise gelten für {from} bis {to}, {nights}.",
  ...
  "imprint.responsibleHeading": {
    de: "Verantwortlich für den Inhalt nach Paragraph 18 Abs. 2 MStV",
  ...
  "imprint.odrBody": {
    de: "Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: {link}. Wir sind nicht verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.",
  ...
  "imprint.liabilityContentBody": {
    de: "Die Inhalte dieser Website wurden mit groesster Sorgfalt erstellt. Für die Richtigkeit, Vollstaendigkeit und Aktualität der Inhalte können wir jedoch keine Gewähr übernehmen.",
  ...
  "privacy.heading": { de: "Datenschutzerklärung", en: "Privacy Policy" },
  ...
  "privacy.gtmBody": {
    de: "Sofern aktiviert, verwenden wir den Google Tag Manager zur Verwaltung von Analyse- und Marketing-Tags. Rechtsgrundlage ist deine Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO, eingeholt über unser Cookie-Banner. Du kannst deine Einwilligung jederzeit widerrufen.",
  ...
  "privacy.affiliateBody": {
    de: "Wenn du auf einen Hotel-Buchungs-Link klickst oder ein Tour-Widget nutzt, werden Cookies dieser Anbieter gesetzt (Affiliate-Tracking). Für dich entstehen keine Mehrkosten. Die Datenschutzhinweise:",
  ...
  "privacy.cookiesBody": {
    de: "Es kommen technisch notwendige sowie optionale Cookies (Analyse, Werbung, Affiliate) zum Einsatz. Beim ersten Besuch erhältst du ein Cookie-Banner, in dem du selektiv entscheiden kannst.",
  ...
  "privacy.rightsContact": {
    de: "Zur Ausuebung genügt eine formlose Nachricht an {email}.",
  ...
  "privacy.lastUpdatedBody": {
    de: "Diese Datenschutzerklärung wurde zuletzt im Mai 2026 ueberarbeitet.",
  ...
  "terms.scopeBody": {
    de: "Diese Nutzungsbedingungen gelten für die Nutzung des Stadtportals {site}-Interaktiv, betrieben von {company}. Mit dem Aufrufen der Website erklaerst du dich mit diesen Bedingungen einverstanden.",
  ...
  "terms.servicesBody": {
    de: "{site}-Interaktiv ist ein redaktionelles Informationsportal. Wir stellen Informationen zu Sehenswürdigkeiten, Hotels, Restaurants, Bezirken und Veranstaltungen bereit. Es besteht kein Anspruch auf Vollstaendigkeit oder Aktualität. {nature}",
  ...
  "terms.finalBody": {
    de: "Es gilt deutsches Recht. Sollten einzelne Bestimmungen unwirksam sein, bleibt die Wirksamkeit der übrigen Bedingungen unberuehrt.",
